...
function readFileLineByLine(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var total, fileStream, rl, _d, rl_1, rl_1_1, line, e_1_1;
...
function getLineValue(line) {
    ...
    var results = [];
    for (var i_1 = 0; i_1 < numberString.length; i_1++) {
        var index = -1;
        while ((index = line.indexOf(numberString[i_1], index + 1)) !== -1) {
            results.push({ index: index, value: i_1 + 1 });
        }
    }
    //First left number
    var i = 0;
    ...
    //Sort by index
    results = results.sort(function (a, b) { return a.index - b.index; });
    var value = parseInt((results[0].value.toString() + results[results.length - 1].value.toString()), 10);
    if (value == 12) {
